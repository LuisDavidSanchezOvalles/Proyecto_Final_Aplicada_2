...
namespace ProyectoFinalAplicada2.Reportes
{
    public class EntradasReport
    {
        ...
        List<Entradas> listaEntradas = EntradasBLL.GetList(e => true);
        ...
        private PdfPTable setPageTitle()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("Reporte de Entradas", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.Colspan = 2;
            pdfCell.Border = 0;
            pdfCell.ExtraParagraphSpace = 0;
        ...
        private void ReportBody()
        {
            ...
            #region Table Header
            pdfCell = new PdfPCell(new Phrase("EntradaId", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            foreach (var item in listaEntradas)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(ObtenerNombre(item.SuplidorId), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
