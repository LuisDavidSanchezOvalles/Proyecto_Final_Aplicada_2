...
namespace ProyectoFinalAplicada2.Reportes
{
    public class UsuariosReport
    {
        ...
        public byte[] Reporte(List<Usuarios> lista)
        {
            ...
            anchoColumnas[3] = 180; //Esta sera la fila 4 nombreUsuario
            anchoColumnas[4] = 180; //Esta sera la fila 5 email
            anchoColumnas[5] = 100; //Esta sera la fila 6 fechaCreacion
            anchoColumnas[6] = 100; //Esta sera la fila 7 fechaModificacion
            anchoColumnas[7] = 140; //Esta sera la fila 8 usuarioIdCreacion
        ...
        private void ReportBody()
        {
            ...
            pdfCell = new PdfPCell(new Phrase("UsuarioId Creacion", fontStyle));
            pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
            pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            pdfCell.BackgroundColor = BaseColor.LightGray;
            pdfTable.AddCell(pdfCell);
            ...
            foreach (var item in listaUsuarios)
            {
                ...
                pdfCell = new PdfPCell(new Phrase(item.UsuarioIdCreacion.ToString(), _fontStyle));
                pdfCell.HorizontalAlignment = Element.ALIGN_CENTER;
                pdfCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                pdfCell.BackgroundColor = BaseColor.White;
                pdfTable.AddCell(pdfCell);
